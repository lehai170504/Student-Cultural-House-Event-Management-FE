...
import { Loader2, Package, Calendar, User, CheckCircle2, Clock, XCircle, TrendingUp, Star } from "lucide-react";
...
export default function GiftHistoryPage() {
  const { studentHistory, loadingHistory, error, loadStudentHistory } = useInvoices();
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-6">
        <div className="mb-4">
          ...
          <p className="text-gray-600 mt-1 text-sm">Xem lại các quà tặng bạn đã đổi</p>
        </div>
        ...
        {loadingHistory ? (
          ...
          <div className="text-center py-12 text-red-600">
            ...
            <Button onClick={() => studentId && loadStudentHistory(studentId)} variant="outline" size="sm">
              Thử lại
            </Button>
          </div>
            ...
            {topProducts.length > 0 && (
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 className="text-lg font-semibold text-gray-900">Sản phẩm đổi nhiều nhất</h2>
                </div>
                    ...
                    >
                      ...
                      <div className="space-y-1 text-xs text-gray-600">
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">{product.totalRedeem}</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Tổng điểm:</span>
                    ...
                    <tr key={invoice.invoiceId} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        <span className="text-sm font-semibold text-orange-600">
                          {invoice.totalCost.toLocaleString("vi-VN")} {invoice.currency}
                        </span>
                      </td>
                      <td className="px-4 py-3 whitespace-nowrap">
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-600">
                        {invoice.createdAt ? formatDate(invoice.createdAt) : "Chưa cập nhật"}
                      </td>
                      <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-600">
                        {invoice.deliveredAt ? (
                          <div>
                            <div className="text-gray-900 font-medium">{formatDate(invoice.deliveredAt)}</div>
                          </div>
                        ) : (
